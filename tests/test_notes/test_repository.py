...
def test_repository_initialization(temp_db_path, mock_embedder):
...
def test_add_note_with_embedding(temp_db_path, mock_embedder):
...
def test_add_note_without_embedding(temp_db_path, mock_embedder):
...
def test_get_all_notes(temp_db_path, mock_embedder):
...
def test_get_note_by_id(temp_db_path, mock_embedder):
...
def test_get_note_by_id_not_found(temp_db_path, mock_embedder):
...
def test_delete_note(temp_db_path, mock_embedder):
...
def test_delete_note_not_found(temp_db_path, mock_embedder):
...
def test_search_similar(temp_db_path, mock_embedder):
